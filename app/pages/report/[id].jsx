  ...
  return (
    <View className="flex-1 bg-surface2">
      ...
      <ScrollView className="flex-1" contentContainerStyle={{ padding: 16, paddingBottom: 80 }} showsVerticalScrollIndicator={false}>
        ...
        <View className="flex-row" style={{ gap: 10, marginBottom: 10 }}><SentimentWordCloud title="Positive" percentage={String(uiData.postPos)} words={uiData.postPosWords} type="positive" /><SentimentWordCloud title="Negative" percentage={String(uiData.postNeg)} words={uiData.postNegWords} type="negative" /></View>
        <SectionTitle>Hashtags</SectionTitle><HashtagCloud hashtags={uiData.hashtagList} />
